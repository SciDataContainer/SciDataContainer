...
The third argument of the function `register()` sets this conversion class as default for NumPy array objects overriding the previous default class. This argument is optional.
